...
// chatbot.js [STRUCTURALLY RECONCILED & FIXED]
// ==========================================================================
...
function injectGatedActionCTAs() {
    ...
    btnWhatsApp.innerHTML = "<i class='fab fa-whatsapp'></i> CONNECT VIA WHATSAPP";
...
// ==========================================================================
// USER-FRIENDLY VERIFICATION FORM GENERATOR
// ==========================================================================
function triggerGatedWall(targetActionGoal) {
    ...
    formContainer.innerHTML = `
        ...
        <button type="button" class="exit-form-btn">↩️ Cancel & Return to Main Menu</button>
    `;
...
async function processCompletedLeadCaptured() {
    ...
    setTimeout(() => {
        hideTyping();
        addBotMessage(`✅ <strong>Thank you, ${flowData.leadName}.</strong> Your request has been processed.`, false);
        
        if (flowData.actionContextTarget && flowData.actionContextTarget.includes("Brochure")) {
            addBotMessage(`🎉 <strong>Access Granted:</strong> <a href="#" onclick="alert('Starting brochure download...'); return false;" class="download-link">Click here to download the file</a>.`, false);
        } else {
            addBotMessage(`📞 Our engineering team will connect with you shortly at <strong>${flowData.leadPhone}</strong>.`, false);
        }
...
function processMessage(userText) {
    ...
    if (cleanText === "Financing & Subsidies" || cleanText === "Subsidy Info" || cleanText === "Subsidy Checker" || cleanText === "📋 Subsidy") {
